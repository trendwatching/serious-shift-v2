...
def phase1_domain_definitions(conn):
    ...
    for d in DOMAINS:
        conn.execute("""
            INSERT INTO domains_v2 (id, name, label, short_description, intro,
                                    description, sort_order, horizon)
        ...
        """, (d['id'], d['name'], d['label'], d['short_description'], d.get('intro', ''),
              d['description'], d['sort_order'], d.get('horizon')))
